...
import { CONNECTOR_CATALOG, findCatalogEntry, CATEGORY_LABELS, type CatalogConnector, type CatalogSetupStep } from '../../connectors-catalog';
...
export function McpConfigPanel() {
  ...
  // Add an HTTP connector: save its URL as plain config
  ...
  if (view === 'setup' && setupConnector) {
    ...
    // Can add once the required CLI is installed (its auth is done locally on the server)
                ...
                <div key={name} className="settings-item">
                  ...
                  <div className="settings-item-info">
                    ...
                    <div className="settings-item-meta">
                      ...
                      {!isHttp && config.Args && <span className="truncate">{config.Args.join(' ')}</span>}
                    </div>
                  </div>
